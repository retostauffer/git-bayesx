...
and Fahrmeir (2004). Interval censoring and some further extensions
...
\index{interval censoring} \index{left truncation}
...
\item[Kneib, T. (2005):] Geoadditive hazard regression for interval censored survival times. SFB 386 discussion Paper ???,
