...
#plotsurf# & visualizes estimated twodimensional surfaces \\
\hline
\end{tabular}
...
\subsection{Plotting twodimensional surfaces}
\label{splusplotsurf} \index{S-plus!plotting twodimensional
surfaces} \index{R!plotting twodimensional surfaces} \index{plotting
twodimensional surfaces}

This subsection describes the usage of the function #plotsurf# for
visualizing twodimensional surfaces. The function #plotsurf# merely
invokes different R / S-plus functions for visualizing
twodimensional data. Thus, users familiar with R / S-plus may prefer
to use this functions directly to gain more flexibility.
...
nonparametrically using twodimensional P-splines and that the
