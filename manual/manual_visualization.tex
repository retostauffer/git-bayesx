...
available via the symbols 'l', 'd', '\_', '-' and 'p', which
correspond to the numbers 1-5, i.e.~
...
\label{splusplotsurf} \index{S-plus!plotting 2 dimensional
surfaces} \index{plotting 2 dimensional surface}
