...
\item[] {\em Example}:
 ...
 {\em Important Remark}: Except for the option #lambda# for the inverse variances,
...
& 2. Provides a starting value of for the variance parameter $\lambda _{j} =1/
  \tau _{j}^{2} $ of the corresponding effect if the lasso- or the ridge-prior is used.
...
#omega#
& Specifies the starting value of the complexity parameter $\omega$. Values have to
