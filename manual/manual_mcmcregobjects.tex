...
\hline\hline
 \multicolumn{3}{l}{1. Continuous distributions on $\dsR$}&Density&Parameters&#family#&#equationtype#\\\hline
...
&&&#lognormal#&#mu#\\
Log-normal & 	$p(y|\mu,\sigma)=\frac{1}{\sqrt{2\pi\sigma^2} y}\exp\left(-\frac{(\log(y)-\mu)^2}{2\sigma^2}\right)$ &$\mu\in\dsR,\sigma^2>0$&#lognormal2#&#sigma2# \\
&&&#lognormal2#&#mu#\\
...
&&&#zinb#&#mu#\\
Hurdle Poisson &&&&\\
Hurdle negative binomial &&&&\\\hline
...
One-inflated Beta & $p(y|\mu,\sigma^2,\tau)=\begin{cases}
		...
		\frac{\tau}{1+\tau} & y=1\\
			\end{cases}$&$\tau>0$\\
\hline
\multicolumn{3}{l}{5. Multivariate distributions} \\\hline	
