...
``predict\_sample.raw'') 
with all
samples of the computed quantities. Note that the size of the output file is even for very simple models
is huge because the number of sampled quantities is proportional to the number of observations. Usually it is
...
#hregress#. More detailed examples can be found in chapter
