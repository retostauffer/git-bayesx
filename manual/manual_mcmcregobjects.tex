...
\hline
\hline
#a#, #b# & The options #a# and #b# specify the hyperparameters of the inverse Gamma prior for the variance $\tau^2$ of nonlinear effects (e.g. P-splines or Markov random fields) and the gamma prior for the shrinkage parameter if ridge or lasso priors are used for linear effects.
& #a=0.001#, #b=0.001# \\
\hline
