...
A graph file stores the nodes and the edges of a graph $G = (N,E)$, see for example \citeasnoun[Ch.~3]{GeoLiu81} for a brief
...
optimised envelope. {\em BayesX} uses the reverse Cuthill Mc-Kee algorithm to reorder maps, see \citeasnoun[p.~58ff]{GeoLiu81}.
\end{stanza}
