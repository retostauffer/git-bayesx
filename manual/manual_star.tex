...
or two dimensional P-splines (Lang and Brezger, 2005), compare
\autoref{spatial}.
...
Bayesian P-splines} (Lang and Brezger, 2005) and {\em Bayesian
...
\label{random}\index{random effects}\index{group indicators}
...
\label{interactions}\index{interactions}\index{varying
coefficients}\index{two-dimensional p-splines}
...
more detail in Lang and Brezger (2004) and Brezger and Lang (2005).
...
\label{glmmrep}\index{mixed model representation}
...
\label{mulitcategoricalresp} \index{MCMC!categorical Response}
...
\label{IWLS}\index{MCMC!exponential families}
...
\label{glmmmeth}\index{empirical Bayes inference}
...
\label{continuoustime}\index{continuous time survival
models}\index{Cox model}
...
censoring}\index{time-varying covariates}\index{left truncation}
