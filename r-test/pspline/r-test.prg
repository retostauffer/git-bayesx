...
r.regress norm1 = x1(psplinerw2) + x2(psplinerw2) + z1*x2(psplinerw2), family=gaussian using d

r.outfile = c:/bayesx/r-test/pspline/output/reml_gauss_vcm2
r.regress norm1 = x1(psplinerw2) + x2(psplinerw2) + z1 + z1*x2(psplinerw2, center), family=gaussian using d

r.outfile = c:/bayesx/r-test/pspline/output/reml_gauss_vcm3
r.regress norm1 = x1(rw1) + x2(psplinerw2) + z1*x2(rw2), family=gaussian using d
...
r.regress bernlogit2 = x1(psplinerw2) + +x2(psplinerw2) + z1*x2(psplinerw2), family=binomial using d
...
r.regress bernprobit2 = x1(psplinerw2) + +x2(psplinerw2) + z1*x2(psplinerw2), family=binomialprobit using d
...
r.regress berncloglog2 = x1(psplinerw2) + +x2(psplinerw2) + z1*x2(psplinerw2), family=binomialcomploglog using d
...
r.regress bin2 = x1(psplinerw2) + +x2(psplinerw2) + z1*x2(psplinerw2) weight binw, family=binomial using d
...
r.regress pois2 = x1(psplinerw2) + +x2(psplinerw2) + z1*x2(psplinerw2), family=poisson using d
...
b.regress norm1 = x1(psplinerw2) + x2(psplinerw2) + z1*x2(psplinerw2), family=gaussian iterations=12000 burnin=2000 step=10 setseed=123 using d

b.outfile = c:/bayesx/r-test/pspline/output/mcmc_gauss_vcm2
b.regress norm1 = x1(psplinerw2) + x2(psplinerw2) + z1 + z1*x2(psplinerw2, center), family=gaussian iterations=12000 burnin=2000 step=10 setseed=123 using d

b.outfile = c:/bayesx/r-test/pspline/output/mcmc_gauss_vcm3
b.regress norm1 = x1(rw1) + x2(psplinerw2) + z1*x2(rw2), family=gaussian iterations=12000 burnin=2000 step=10 setseed=123 using d
...
b.regress bernlogit2 = x1(psplinerw2) + +x2(psplinerw2) + z1*x2(psplinerw2), family=binomial iterations=12000 burnin=2000 step=10 setseed=123 using d
...
b.regress bernprobit2 = x1(psplinerw2) + +x2(psplinerw2) + z1*x2(psplinerw2), family=binomialprobit iterations=12000 burnin=2000 step=10 setseed=123 using d
...
b.regress bin2 = x1(psplinerw2) + +x2(psplinerw2) + z1*x2(psplinerw2) weight binw, family=binomial iterations=12000 burnin=2000 step=10 setseed=123 using d
...
b.regress pois2 = x1(psplinerw2) + +x2(psplinerw2) + z1*x2(psplinerw2), family=poisson iterations=12000 burnin=2000 step=10 setseed=123 using d
...
s.regress norm1 = x1(psplinerw2) + x2(psplinerw2) + z1*x2(psplinerw2), family=gaussian using d

s.outfile = c:/bayesx/r-test/pspline/output/step_gauss_vcm2
s.regress norm1 = x1(psplinerw2) + x2(psplinerw2) + z1 + z1*x2(psplinerw2, center), family=gaussian using d

s.outfile = c:/bayesx/r-test/pspline/output/step_gauss_vcm3
s.regress norm1 = x1(rw1) + x2(psplinerw2) + z1*x2(rw2), family=gaussian using d
...
s.regress bernlogit2 = x1(psplinerw2) + +x2(psplinerw2) + z1*x2(psplinerw2), family=binomial using d
...
s.regress bernprobit2 = x1(psplinerw2) + +x2(psplinerw2) + z1*x2(psplinerw2), family=binomialprobit using d
...
s.regress bin2 = x1(psplinerw2) + +x2(psplinerw2) + z1*x2(psplinerw2) weight binw, family=binomial using d
...
s.regress pois2 = x1(psplinerw2) + +x2(psplinerw2) + z1*x2(psplinerw2), family=poisson using d