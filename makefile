...
gnuobj/FC_cv.o: structadd/FC_cv.cpp
	$(CPP) -c structadd/FC_cv.cpp -o gnuobj/FC_cv.o $(CXXFLAGS)

gnuobj/FC_variance_pen_vector.o: structadd/FC_variance_pen_vector.cpp
	$(CPP) -c structadd/FC_variance_pen_vector.cpp -o gnuobj/FC_variance_pen_vector.o $(CXXFLAGS)

gnuobj/distr_mixture.o: structadd/distr_mixture.cpp
	$(CPP) -c structadd/distr_mixture.cpp -o gnuobj/distr_mixture.o $(CXXFLAGS)
