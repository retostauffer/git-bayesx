...
\epsfig{file=grafiken/f_age3.ps,scale=0.5} {\it\caption{Results
...
\epsfig{file=grafiken/f_age4.ps,scale=0.5} {\it\caption{Results
...
\epsfig{file=grafiken/f_age5.ps,scale=0.5} {\it\caption{Results
for the nonparametric effects with hyper parameters $a=1$ and
