...
////------------------------------------------------------------------------------
////--------------------------- CLASS: DISTR_betainf0_mu --------------------------
////------------------------------------------------------------------------------
//
//
//DISTR_betainf0_mu::DISTR_betainf0_mu(GENERAL_OPTIONS * o,
//                                           const datamatrix & r,
//                                           const datamatrix & w)
...
//
//
//DISTR_betainf0_mu::DISTR_betainf0_mu(const DISTR_betainf0_mu & nd)
...
//
//
//const DISTR_betainf0_mu & DISTR_betainf0_mu::operator=(
//                            const DISTR_betainf0_mu & nd)
//  {
//  if (this==&nd)
//    return *this;
...
//
//
//double DISTR_betainf0_mu::get_intercept_start(void)
//  {
//  return 0; // log(response.mean(0));
//  }
//
//void DISTR_betainf0_mu::compute_param(const double * linpred,double * param)
//  {
//  double arg = exp(*linpred);
//  *param = arg/(1+arg);
//  }
//
//double DISTR_betainf0_mu::loglikelihood_weightsone(double * response,
//                                                 double * linpred)
//  {
//
...
//
//
//void DISTR_betainf0_mu::compute_iwls_wweightschange_weightsone(
//                                              double * response,
//                                              double * linpred,
...
//
//
//void DISTR_betainf0_mu::outoptions(void)
//  {
//  DISTR::outoptions();
...
//
//
//void DISTR_betainf0_mu::update_end(void)
//  {
//
//
...
//
////------------------------------------------------------------------------------
////------------------------- CLASS: DISTR_betainf0_sigma2 ------------------------
////------------------------------------------------------------------------------
//
//
//DISTR_betainf0_sigma2::DISTR_betainf0_sigma2(GENERAL_OPTIONS * o,
//                                           const datamatrix & r,
//                                           const datamatrix & w)
//  : DISTR_gamlss(o,r,1,w)
//  {
...
//
//
//DISTR_betainf0_sigma2::DISTR_betainf0_sigma2(const DISTR_betainf0_sigma2 & nd)
//   : DISTR_gamlss(DISTR_gamlss(nd))
//  {
//
//  }
//
//
//const DISTR_betainf0_sigma2 & DISTR_betainf0_sigma2::operator=(
//                            const DISTR_betainf0_sigma2 & nd)
//  {
//  if (this==&nd)
//    return *this;
//  DISTR_gamlss::operator=(DISTR_gamlss(nd));
...
//
//
//double DISTR_betainf0_sigma2::get_intercept_start(void)
//  {
//  return 0; // log(response.mean(0));
//  }
//
//void DISTR_betainf0_sigma2::compute_param(const double * linpred,double * param)
//  {
//   double arg = exp(*linpred);
//  *param = arg/(1+arg);
//  }
//
//double DISTR_betainf0_sigma2::loglikelihood_weightsone(double * response,
//                                                 double * linpred)
//  {
//
...
//  }
//
//void DISTR_betainf0_sigma2::compute_iwls_wweightschange_weightsone(
//                                              double * response,
//                                              double * linpred,
//                                              double * workingweight,
//                                              double * workingresponse,
...
//
//
//void DISTR_betainf0_sigma2::outoptions(void)
//  {
//  DISTR::outoptions();
...
//
//
//void DISTR_betainf0_sigma2::update_end(void)
//  {
//
