...
//------------------------------------------------------------------------------
//----- CLASS: pspline_multibaseline (implementation of member functions) ------
//------------------------------------------------------------------------------
...
/*void pspline_multibaseline::outresults(void)
  {
...
void pspline_multibaseline::compute_int_ti_linear(const double & b)
  {
...
void pspline_multibaseline::compute_int_ti_weibull(const double & r)
  {
  double * int_ti_p=likep->get_integral_ti();
  for(unsigned i=0;i<zi.rows();i++,int_ti_p++)
    {
...
void pspline_multibaseline::compute_int_ti(unsigned beg)
{
double * int_D_help;
double * betap;
double dist_knots=int_knots(1,0)-int_knots(0,0);
...
void pspline_multibaseline::compute_int_ti_vc_di0(const vector<double *> splinevector,const vector<double *> betavector)
{
...
void pspline_multibaseline::compute_int_ti_vc_di(const int dummy, const vector<double *> splinevector,const vector<double *> betavector)
{
double * betap;
double dist_knots=int_knots(1,0)-int_knots(0,0);
...
void pspline_multibaseline::compute_int_gauss(void)
{
...
void pspline_multibaseline::compute_int_gauss_DIC(void)
{
...
void pspline_multibaseline::update_baseline()
{
//---------Integral berechnen---------------------------------
unsigned i;
if(baselinep.size()>=1)
...
double * pspline_multibaseline::get_gaussspline()
  {
...
double * pspline_multibaseline::get_gaussspline_mean()
  {
  datamatrix egon (gaussspline.rows(),1,0);
  for(unsigned i=0;i<gauss_n;i++)
    {
...
void pspline_multibaseline::create_lgamma(void)
  {
...
double pspline_multibaseline::lgammafunc(const double & nu) const
    {
...
double pspline_multibaseline::lfac(const double & nu) const
    {
